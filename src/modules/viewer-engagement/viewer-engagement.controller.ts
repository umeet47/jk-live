...
export const getAllViewerEngagementDurationPerDayForGivenViewer = api(
    { expose: true, method: "GET", path: "/viewer-engagement/duration/:viewerId" },
...
export const getAllViewerEngagementsForGivenViewer = api(
    { expose: true, method: "GET", path: "/viewer-engagement/:viewerId" },
...
export const getAllViewerEngagementDurationPerDay = api(
    { expose: true, method: "GET", path: "/viewer-engagement/all/duration/list" },
...
export const getAllViewerEngagements = api(
    { expose: true, method: "GET", path: "/viewer-engagement/all/list" },
