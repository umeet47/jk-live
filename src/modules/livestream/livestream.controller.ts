...
export const resetLiveStreamData = api(
    { expose: true, auth: true, method: "GET", path: "/livestream/all/reset" },
...
export const getAll = api(
    { expose: true, auth: true, method: "GET", path: "/livestream" },
...
export const getDailyStreamDuration = api(
    { expose: true, auth: true, method: "GET", path: "/livestream/duration/:hostId/:date" },
...
export const getAllLiveStreamsDurationPerDay = api(
    { expose: true, auth: true, method: "GET", path: "/livestream/all/duration/:hostId" },
...
export const getDailyStream = api(
    { expose: true, auth: true, method: "GET", path: "/livestream/:hostId/:date" },
...
export const getAllLiveStreams = api(
    { expose: true, auth: true, method: "GET", path: "/livestream/all/:hostId" },
...
export const getTopFiveHostLiveStreamer = api(
    { expose: true, auth: true, method: "GET", path: "/livestream/top-five" },
...
export const getTotalProducerTime = api(
    { expose: true, auth: true, method: "GET", path: "/livestream/producer-time/:liveStreamId" },
...
export const getTotalProducerTimeForDuration = api(
    { expose: true, auth: true, method: "GET", path: "/livestream/producer-time/duration" },
...
export const getTotalConsumingTime = api(
    { expose: true, auth: true, method: "GET", path: "/livestream/consuming-time/:liveStreamId/:userId" },
...
export const getAllProducerActivity = api(
    { expose: true, auth: true, method: "GET", path: "/livestream/producer-activity" },
    async (): Promise<{ success: boolean; data: any[] }> => {
...
export const getAllLiveStreamParticipants = api(
    { expose: true, auth: true, method: "GET", path: "/livestream/participant-activity" },
    async (): Promise<{ success: boolean; data: any[] }> => {
...
export const getTotalDurationByUserId = api(
    { expose: true, auth: true, method: "GET", path: "/livestream/total-duration/:userId" },
...
export const getTotalDuration = api(
    { expose: true, auth: true, method: "GET", path: "/livestream/total-duration" },
    async (): Promise<{
        success: boolean; data: {
            totalSeconds: number
            formattedDuration: string
...
export const getTotalProducerAndParticipantActivity = api(
    { expose: true, auth: true, method: "GET", path: "/livestream/producer/participant-activity" },
    async (): Promise<{ success: boolean; data: any }> => {
...
export const getTotalProducerAndParticipantActivityForRoomId = api(
    { expose: true, auth: true, method: "GET", path: "/livestream/producer/participant-activity/:roomId" },
...
export const fetchTotalTimeUsed = api(
    { expose: true, auth: true, method: "GET", path: "/livestream/total/time-taken" },
    async (): Promise<{
        success: boolean; data: any[]
    }> => {
...
export const deleteAllLiveStreamProducerData = api(
    { expose: true, auth: true, method: "GET", path: "/livestream/remove" },
    async (): Promise<{
        success: boolean;
    }> => {
...
export const getTotalRoomIds = api(
    { expose: true, auth: true, method: "GET", path: "/livestream/total/room-ids" },
    async (): Promise<{
...
export const getTotalLiveStreams = api(
    { expose: true, auth: true, method: "GET", path: "/livestream/total/created" },
    async (): Promise<{
